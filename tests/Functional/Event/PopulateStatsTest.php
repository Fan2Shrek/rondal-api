...
class PopulateStatsTest extends KernelTestCase
{
    ...
    public function test_populate_on_success(): void
    {
        ...
        $this->assertEquals(['dummyprovider' => ['success' => 1]], $this->getPopulateStatsSubscriber()->getStats());
    }
    ...
    public function test_populate_on_fail(): void
    {
        ...
        $this->assertEquals(['dummyprovider' => ['failed' => 1]], $this->getPopulateStatsSubscriber()->getStats());
    }
    ...
    public function test_populate_both(): void
    {
        ...
        $this->assertEquals(['dummyprovider' => ['success' => 1, 'failed' => 1]], $this->getPopulateStatsSubscriber()->getStats());
    }
